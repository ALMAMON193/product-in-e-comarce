    ...
    <nav aria-label="breadcrumb" class="mb-4 lg:mb-6">
        <ol class="flex items-center space-x-2 text-sm text-gray-500">
            ...
            <li class="text-gray-800 font-semibold flex items-center">
                <i class="fas fa-eye mr-1"></i>SubCategory Details
            </li>
        </ol>
    </nav>
        ...
        <section class="lg:col-span-4 bg-white/95 rounded-xl shadow-2xl p-6 border border-gray-100/50 backdrop-blur-sm">
            ...
            <div class="flex items-center justify-between mb-6">
                <div class="flex items-center space-x-3">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900 tracking-tight">{{ $subCategory->name }}</h2>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <p class="text-gray-800 text-lg">{{ $subCategory->name }}</p>
                        </div>

                        <div>
                            <label class="block text-gray-700 font-medium mb-1 flex items-center">
                                <i class="fas fa-layer-group mr-2"></i>Parent Category
                            </label>
                            <p class="text-gray-600">
                                {{ $subCategory->category ? $subCategory->category->name : 'No parent category' }}
                            </p>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <span
                                    class="text-sm font-medium {{ $subCategory->is_featured ? 'bg-indigo-100 text-indigo-700' : 'bg-gray-100 text-gray-700' }} px-2 py-1 rounded-full">
